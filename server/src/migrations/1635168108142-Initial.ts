...
export class Initial1635168108142 implements MigrationInterface {
    name = 'Initial1635168108142'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "room" ("id" SERIAL NOT NULL, "title" character varying NOT NULL, "public" boolean NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "dm" boolean, "creatorId" integer, CONSTRAINT "UQ_24335bb983c2df0d4e3d44f6cca" UNIQUE ("title"), CONSTRAINT "PK_c6d46db005d623e691b2fbcba23" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "message" ("id" SERIAL NOT NULL, "content" text NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "creatorId" integer, "roomId" integer, "responseId" integer, CONSTRAINT "PK_ba01f0a3e0123651915008bc578" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "logtimes" ("id" SERIAL NOT NULL, "timeStart" TIMESTAMP NOT NULL, "timeEnd" TIMESTAMP, "memberId" integer, CONSTRAINT "PK_262308a002158bdcbe215002e3f" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "message" ADD CONSTRAINT "FK_ab982530cba24233b9a8a8b695f" FOREIGN KEY ("responseId") REFERENCES "message"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "message" DROP CONSTRAINT "FK_ab982530cba24233b9a8a8b695f"`);
